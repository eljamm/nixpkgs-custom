...
stdenv.mkDerivation (finalAttrs: {
  ...
  inNixpkgs = devLib.warnIfCond (
    pkgs ? zelph && devLib.isNewerOrSame pkgs.zelph finalAttrs.finalPackage
  ) "`${finalAttrs.pname}` is now available in Nixpkgs: https://github.com/NixOS/nixpkgs/pull/561908";
